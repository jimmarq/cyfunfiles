# Exercise: String Comparisons with If/Else
...
# If they are the same length, print: 
#   "The lengths of the two strings are equal."
# If string1 is longer, print: 
...
# If string1 comes first alphabetically, print:
#   "The first string comes before the second string."
# If string1 comes second alphabetically, print:
