...
# the math package to help calculate
...
# Create a variable called 'radius' and 
# assign it a value of 5


# Step 4: Calculate the area of a circle
# using the math package. Calculate the
# area using the formula:
#
#   area = pi * radius^2
#
# (Remember to use the python notation 
# for powers)
